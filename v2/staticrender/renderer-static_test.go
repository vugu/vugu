...
func (c *Root) panicingFunc() {
	...
	for _, tc := range tcList {
		t.Run(tc.name, func(t *testing.T) {
			...
			startf["go.mod"] = "module testcase\nreplace github.com/vugu/vugu/v2 => " + vuguDir + "\n"
...
import (
	...
	"github.com/vugu/vugu/v2/staticrender"
)
...
// replace github.com/vugu/vugu/v2 => %s
// require github.com/vugu/vugu/v2 v0.0.0-00010101000000-000000000000
// `, vuguwd)), 0644)
