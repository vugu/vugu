...
import demolinealias "github.com/vugu/vugu/v2/wasm-test-suite/test-004-component-import-alias/components"
	...
	vgout.Out = append(vgout.Out, vgn) // root for output
	{
		...
		vgparent.AppendChild(vgn)
		{
			...
			for i := 0; i < c.ItemCount; i++ {
				{
					vgcompKey := vugu.MakeCompKey(0x9880F736472B2AB8^vgin.CurrentPositionHash(), i)
					// ask BuildEnv for prior instance of this specific component
					vgcomp, _ := vgin.BuildEnv.CachedComponent(vgcompKey).(*demolinealias.DemoLine)
					if vgcomp == nil {
						// create new one if needed
						vgcomp = new(demolinealias.DemoLine)
		...
		})
		{
			vgparent := vgn
			_ = vgparent
			vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "Add"}}
			vgparent.AppendChild(vgn)
		}
		vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n\n"}}
		vgparent.AppendChild(vgn)
