...
// See Issue #328 https://github.com/vugu/vugu/v2/issues/328
...
func (c *Root) panicingFunc() {
	date := js.Global().Get("Date") // NOTE: use of double quotes not single quotes as in Issue #328 https://github.com/vugu/vugu/v2/issues/328
