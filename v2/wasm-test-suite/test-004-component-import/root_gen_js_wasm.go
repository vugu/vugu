...
import "github.com/vugu/vugu/v2/wasm-test-suite/test-004-component-import/components"
			...
			for i := 0; i < c.ItemCount; i++ {
				{
					...
					vgcomp, _ := vgin.BuildEnv.CachedComponent(vgcompKey).(*components.DemoLine)
					if vgcomp == nil {
						// create new one if needed
						vgcomp = new(components.DemoLine)
