	...
	vgout.Out = append(vgout.Out, vgn)	// root for output
	{
		...
		vgparent.AppendChild(vgn)
		{
			...
			vgparent.AppendChild(vgn)
			{
				...
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                "}}
				vgparent.AppendChild(vgn)
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " Create a red rectangle and listen for mouse entry adn exit events, and clicks "}}
				vgparent.AppendChild(vgn)
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "               \n                "}}
				vgparent.AppendChild(vgn)
				...
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n\n                "}}
				vgparent.AppendChild(vgn)
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " Create a text area and listen for keydown events "}}
				vgparent.AppendChild(vgn)
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                "}}
				vgparent.AppendChild(vgn)
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " TODO: Note: if the text area is resized then the next keydown event will reset the size to the default. Is theis a vugu bug?? "}}
				vgparent.AppendChild(vgn)
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: " \n                "}}
				vgparent.AppendChild(vgn)
				...
				vgparent.AppendChild(vgn)
				{
					...
					})
					{
						vgparent := vgn
						_ = vgparent
						vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "Type in here"}}
						vgparent.AppendChild(vgn)
					}
					vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                "}}
					vgparent.AppendChild(vgn)
				...
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n    \n                "}}
				vgparent.AppendChild(vgn)
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " Create a button and listen for left, right and double click events "}}
				vgparent.AppendChild(vgn)
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                "}}
				vgparent.AppendChild(vgn)
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " A double click event also emits two single click events "}}
				vgparent.AppendChild(vgn)
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                "}}
				vgparent.AppendChild(vgn)
				...
				})
				{
					vgparent := vgn
					_ = vgparent
					vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "Click, right-click and double click me!"}}
					vgparent.AppendChild(vgn)
				}
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n\n                "}}
				vgparent.AppendChild(vgn)
				...
				vgparent.AppendChild(vgn)
				{
					...
					vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                    "}}
					vgparent.AppendChild(vgn)
					vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " Print out the events in reverse order "}}
					vgparent.AppendChild(vgn)
					vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                    "}}
					vgparent.AppendChild(vgn)
