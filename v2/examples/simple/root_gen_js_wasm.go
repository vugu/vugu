			...
			vgparent.AppendChild(vgn)
			{
				...
				vgparent.AppendChild(vgn)
				{
					...
					})
					{
						vgparent := vgn
						_ = vgparent
						vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "WebAssembly"}}
						vgparent.AppendChild(vgn)
					}
					vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: ",\n                written in\n                "}}
					vgparent.AppendChild(vgn)
					...
					})
					{
						vgparent := vgn
						_ = vgparent
						vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "Go"}}
						vgparent.AppendChild(vgn)
					}
					vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                using\n                "}}
					vgparent.AppendChild(vgn)
					...
					})
					{
						vgparent := vgn
						_ = vgparent
						vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "Vugu"}}
						vgparent.AppendChild(vgn)
					}
					vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: ".\n            "}}
					vgparent.AppendChild(vgn)
				...
				if c.ShowWasm {
					...
					vgparent.AppendChild(vgn)
					{
						...
						vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                "}}
						vgparent.AppendChild(vgn)
						vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(3), Namespace: "", Data: "strong", Attr: []vugu.VGAttribute(nil)}}
						vgparent.AppendChild(vgn)
						{
							vgparent := vgn
							_ = vgparent
						...
						vgparent.AppendChild(vgn)
						{
							vgparent := vgn
							_ = vgparent
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "Read more at webassembly.org »"}}
							vgparent.AppendChild(vgn)
						}
						vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n            "}}
						vgparent.AppendChild(vgn)
				...
				if c.ShowGo {
					...
					vgparent.AppendChild(vgn)
					{
						...
						vgparent.AppendChild(vgn)
						{
							vgparent := vgn
							_ = vgparent
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "Read more at golang.org »"}}
							vgparent.AppendChild(vgn)
						}
						vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n            "}}
						vgparent.AppendChild(vgn)
					...
					vgparent.AppendChild(vgn)
					{
						...
						if time.Now().Year() >= 2020 {
							...
							vgparent.AppendChild(vgn)
							{
								vgparent := vgn
								_ = vgparent
								vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "most"}}
								vgparent.AppendChild(vgn)
							}
						}
