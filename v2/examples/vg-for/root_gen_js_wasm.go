	...
	vgout.Out = append(vgout.Out, vgn)	// root for output
	{
		...
		vgparent.AppendChild(vgn)
		{
			...
			vgparent.AppendChild(vgn)
			{
				...
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n            "}}
				vgparent.AppendChild(vgn)
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(3), Namespace: "", Data: "h1", Attr: []vugu.VGAttribute(nil)}}
				vgparent.AppendChild(vgn)
				vgn.SetInnerHTML(vugu.HTML("vg-for Loop Examples"))
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                "}}
				vgparent.AppendChild(vgn)
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " Add some buttons that trigger methods on the component when clicked "}}
				vgparent.AppendChild(vgn)
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                "}}
				vgparent.AppendChild(vgn)
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " The methods toggle the vidsibility of each of the 4 different loop examples "}}
				vgparent.AppendChild(vgn)
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                "}}
				vgparent.AppendChild(vgn)
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " 'c' is an instance of the `Root` structure. The methods are attached to the Root stucture as normal in the Go code "}}
				vgparent.AppendChild(vgn)
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                "}}
				vgparent.AppendChild(vgn)
				...
				})
				{
					vgparent := vgn
					_ = vgparent
					vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "Toggle \"for i\" loop"}}
					vgparent.AppendChild(vgn)
				}
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                "}}
				vgparent.AppendChild(vgn)
				...
				})
				{
					vgparent := vgn
					_ = vgparent
					vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "Togglle \"key value\" loop"}}
					vgparent.AppendChild(vgn)
				}
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                "}}
				vgparent.AppendChild(vgn)
				...
				})
				{
					vgparent := vgn
					_ = vgparent
					vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "Togglle \"shortcut\" loop"}}
					vgparent.AppendChild(vgn)
				}
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                "}}
				vgparent.AppendChild(vgn)
				...
				})
				{
					vgparent := vgn
					_ = vgparent
					vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "Toggle \"sorted\" loop"}}
					vgparent.AppendChild(vgn)
				}
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                "}}
				vgparent.AppendChild(vgn)
				...
				})
				{
					vgparent := vgn
					_ = vgparent
					vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "Toggle \"iterator based\" loop"}}
					vgparent.AppendChild(vgn)
				}
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n\n                "}}
				vgparent.AppendChild(vgn)
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " Use an vg-if test to see if we should show this <div> at all. "}}
				vgparent.AppendChild(vgn)
				vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                "}}
				vgparent.AppendChild(vgn)
				if c.ShowForILoop() {
					...
					vgparent.AppendChild(vgn)
					{
						...
						vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                    "}}
						vgparent.AppendChild(vgn)
						vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(3), Namespace: "", Data: "h3", Attr: []vugu.VGAttribute(nil)}}
						vgparent.AppendChild(vgn)
						vgn.SetInnerHTML(vugu.HTML(" for i style for loop example "))
						vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                    "}}
						vgparent.AppendChild(vgn)
						vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(3), Namespace: "", Data: "ul", Attr: []vugu.VGAttribute(nil)}}
						vgparent.AppendChild(vgn)
						{
							vgparent := vgn
							_ = vgparent
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                        "}}
							vgparent.AppendChild(vgn)
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " use the \"for i\" (for initilizer; condition; increment) form of a  `vg-for` to loop over the days in the week "}}
							vgparent.AppendChild(vgn)
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                        "}}
							vgparent.AppendChild(vgn)
							for i := 0; i < c.DaysInWeek(); i++ {
								vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(3), Namespace: "", Data: "li", Attr: []vugu.VGAttribute(nil)}}
								vgparent.AppendChild(vgn)
								{
									vgparent := vgn
									_ = vgparent
									vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                            "}}
									vgparent.AppendChild(vgn)
									vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " Use a vg-content to set the content of this div "}}
									vgparent.AppendChild(vgn)
									vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                            "}}
									vgparent.AppendChild(vgn)
									vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " Use the DayOfWeek(int) string method of the (Root) component to return the day of the week "}}
									vgparent.AppendChild(vgn)
									vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                            "}}
									vgparent.AppendChild(vgn)
									vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(3), Namespace: "", Data: "div", Attr: []vugu.VGAttribute(nil)}}
						...
						vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                    "}}
						vgparent.AppendChild(vgn)
						vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(3), Namespace: "", Data: "hr", Attr: []vugu.VGAttribute(nil)}}
						vgparent.AppendChild(vgn)
				...
				if c.ShowKVLoop() {
					...
					vgparent.AppendChild(vgn)
					{
						...
						vgparent.AppendChild(vgn)
						{
							...
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                        "}}
							vgparent.AppendChild(vgn)
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " Use the explicit key value form of a vg-for loop to iterate over a map "}}
							vgparent.AppendChild(vgn)
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                        "}}
							vgparent.AppendChild(vgn)
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " The method on the (root) component, c, DaysInWeekIth returns a map[string]string "}}
							vgparent.AppendChild(vgn)
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: " \n                        "}}
							vgparent.AppendChild(vgn)
				...
				if c.ShowShortCutLoop() {
					...
					vgparent.AppendChild(vgn)
					{
						...
						vgparent.AppendChild(vgn)
						{
							...
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                        "}}
							vgparent.AppendChild(vgn)
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " vg-for supports a special case that can act as a shortcut "}}
							vgparent.AppendChild(vgn)
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                        "}}
							vgparent.AppendChild(vgn)
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " if the string following the vg-for= DOES NOT CONTAIN WHITESPACE then it will be expanded to: "}}
							vgparent.AppendChild(vgn)
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                        "}}
							vgparent.AppendChild(vgn)
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " for key, value := range expr  "}}
							vgparent.AppendChild(vgn)
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                        "}}
							vgparent.AppendChild(vgn)
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " the expr should return two values and can be a method, in this case the DayInWeekIth method on the component c "}}
							vgparent.AppendChild(vgn)
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                        "}}
							vgparent.AppendChild(vgn)
							for key, value := range c.DaysInWeekIth() {
								...
								vgparent.AppendChild(vgn)
								{
									...
									vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                            "}}
									vgparent.AppendChild(vgn)
									vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " When using the vg-content we can reference the variables \"key\" and \"value\" that will implicitly be defined bu the shortcut "}}
									vgparent.AppendChild(vgn)
									vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                            "}}
									vgparent.AppendChild(vgn)
									vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(3), Namespace: "", Data: "div", Attr: []vugu.VGAttribute(nil)}}
				...
				if c.ShowSortedLoop() {
					...
					vgparent.AppendChild(vgn)
					{
						...
						vgparent.AppendChild(vgn)
						{
							...
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                        "}}
							vgparent.AppendChild(vgn)
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " This example uses the explicit form of the vg-for "}}
							vgparent.AppendChild(vgn)
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                        "}}
							vgparent.AppendChild(vgn)
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(4), Data: " This time the methods c.DaysInWeekIthSorted uses the new iter, sllice and maps package internally "}}
							vgparent.AppendChild(vgn)
							vgn = &vugu.VGNode{VGNodeCommonCore: vugu.VGNodeCommonCore{Type: vugu.VGNodeType(1), Data: "\n                        "}}
							vgparent.AppendChild(vgn)
