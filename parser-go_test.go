...
// // 	str := `<html><body><test:blah>testing</test:blah></body></html>`

// // 	n, err := html.Parse(bytes.NewReader([]byte(str)))
// // 	assert.NoError(err)
// // 	// log.Printf("n = %#v", n.FirstChild.FirstChild.FirstChild)
// // 	log.Printf("n = %#v", n.FirstChild.FirstChild.NextSibling.FirstChild)
